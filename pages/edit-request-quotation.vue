...
<template>
  <div>
    ...
    <form @submit.prevent="handleSubmit">
      <div
        class="mx-auto max-w-4xl rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900"
      >
        <!-- Company Header -->
        <div
        ...
        <p class="mb-4 text-xs italic text-gray-600 dark:text-gray-400">
          Yours faithfully,<br />
          Please provide an offer for the provision of the following goods/services with the best quality, price, and delivery
          time via fax or email.
        </p>
