      ...
      <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900 space-y-8">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <!-- Regular Overtime -->
            <div
              class="grid grid-cols-1 gap-3 sm:grid-cols-4 items-center rounded-lg border border-gray-100 p-3 dark:border-gray-800"
            >
        ...
        <div class="space-y-4">
          ...
          <!-- Dynamic allowances -->
          <div
            v-for="(item, idx) in form.allowanceItems"
            :key="item.id"
            class="grid grid-cols-1 gap-3 sm:grid-cols-12 items-center rounded-lg border border-gray-100 p-3 dark:border-gray-800"
          >
            <div class="sm:col-span-4">
              <div v-if="!item.isEditing" class="flex items-center gap-2">
                ...
                <button type="button" class="text-xs italic text-rose-500 hover:underline" @click="removeAllowance(idx)">
                  remove
                </button>
              </div>
        ...
        <div class="space-y-4">
          ...
          <!-- Dynamic deductions -->
          <div
            v-for="(item, idx) in form.deductionItems"
            :key="item.id"
            class="grid grid-cols-1 gap-3 sm:grid-cols-12 items-center rounded-lg border border-gray-100 p-3 dark:border-gray-800"
          >
            <div class="sm:col-span-4">
              <div v-if="!item.isEditing" class="flex items-center gap-2">
                ...
                <button type="button" class="text-xs italic text-rose-500 hover:underline" @click="removeDeduction(idx)">
                  remove
                </button>
              </div>
              <div v-else class="flex items-center gap-2">
