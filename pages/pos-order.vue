      ...
      <div class="page-header">
        <div class="add-item d-flex">
          <div class="page-title">
            <h4>POS Orders</h4>
            <h6>Manage in-store point of sale transactions and receipts</h6>
          </div>
        </div>
            ...
            <div class="search-set d-flex align-items-center gap-2 flex-wrap">
              <div class="search-input">
                ...
                <input
                  ...
                  type="text"
                  class="form-control"
                  placeholder="Search reference, customer, or biller..."
                />
              </div>
            </div>
            ...
            <table class="table datanew">
              ...
              <tbody>
                ...
                <tr v-if="filteredOrders.length === 0">
                  <td colspan="10" class="text-center py-4 text-muted">No POS orders found.</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header border-0">
            <h5 class="modal-title font-bold">POS Order: {{ selectedOrder?.reference }}</h5>
...
function viewDetail(order: PosOrder) {
