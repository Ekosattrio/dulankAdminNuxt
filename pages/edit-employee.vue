...
const form = reactive({
  ...
  department: "Produksi",
  contactPerson1: "Dudung Sukaya",
  contactPhone1: "6258454455555",
  contactPerson2: "Mimin Mintarsih",
  contactPhone2: "62854515422255",
...
<template>
  <div class="space-y-6">
    <!-- Page Header -->
    <CommonPageHeader title="Edit Employee" subtitle="Update employee information">
      <template #actions>
        <NuxtLink
          to="/employees"
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div class="relative">
              <label class="mb-1 block text-xs font-semibold text-gray-700 dark:text-gray-300"
                >Address (Provinsi, Kota, Kecamatan)</label
              >
