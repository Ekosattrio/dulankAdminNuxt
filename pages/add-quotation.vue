...
const quotationDate = ref(new Date().toISOString().substring(0, 10))
...
const selectedCustomer = ref<Customer | null>({
  ...
  address: 'Toko Kelontong Depan Desa Teluk Jambe, 515 Sarah Shore Suite 828, Port Kennethstad, KAB. KARAWANG - TELUK JAMBE TIMUR, JAWA BARAT, ID 41360'
})

const shippingMethod = ref<'shipping' | 'pickup'>('shipping')

const shippingAddress = ref({
  recipient: 'Ahmad Dhani',
  phone: '(+62) 852053769',
  type: 'Office',
  detail: 'Toko Kelontong Depan Desa Teluk Jambe, 515 Sarah Shore Suite 828, Port Kennethstad (Depan Stasiun), KAB. KARAWANG - TELUK JAMBE TIMUR, JAWA BARAT, ID 41360'
})

const pickupStore = ref({
  storeName: 'Dulank Pickup 2',
  phone: '081906855554',
  detail: 'Toko Kelontong Depan Desa Teluk Jambe, 515 Sarah Shore Suite 828, Port Kennethstad, Iowa, TH, KAB. KARAWANG - TELUK JAMBE TIMUR, JAWA BARAT, ID 41360'
})
...
const terms = ref([
  ...
  'Penawaran ini berlaku 30 hari'
])

// Add item from live search or manually
...
<template>
  <div>
    ...
    <form @submit.prevent="handleSubmit">
      <div class="mx-auto max-w-5xl rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between border-b border-gray-100 pb-6 dark:border-gray-800">
          <div class="flex h-24 w-44 items-center justify-center rounded-lg border border-dashed border-gray-300 bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="mb-6 grid grid-cols-1 gap-6 rounded-xl border border-gray-100 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-gray-800/30 sm:grid-cols-2 text-xs">
          <!-- Customer Section -->
          <div>
          ...
          <div>
            ...
            <div v-if="shippingMethod === 'shipping'" class="rounded-lg border border-gray-200 bg-white p-3 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
          ...
          <div class="text-end">
            ...
            <div class="my-10 font-bold text-gray-900 dark:text-white">Cecep Sudirman</div>
            <p>Director</p>
          </div>
        </div>
    ...
    <BaseModal
      ...
      size="md"
    >
      <form class="p-5 space-y-4 text-xs" @submit.prevent="handleCustomerCreated">
        <div>
          <label class="font-semibold text-gray-700 dark:text-gray-300">Customer Name</label>
          <input
        ...
        <div class="flex justify-end gap-2 pt-2">
          <button
            type="button"
            class="rounded border border-gray-200 px-4 py-1.5 text-xs text-gray-600 hover:bg-gray-100"
            @click="addCustomerModalOpen = false"
          >
            Cancel
          </button>
          <button
            type="submit"
            class="rounded bg-primary px-4 py-1.5 text-xs font-semibold text-white hover:bg-primary/90"
          >
            Save Customer
          </button>
        </div>
    ...
    >
      <div class="p-5 text-xs space-y-4">
        <div>
          <label class="font-semibold text-gray-700 dark:text-gray-300">Address Details</label>
          <textarea
        ...
        <div class="flex justify-end">
          <button
            type="button"
            class="rounded bg-primary px-4 py-1.5 text-xs font-semibold text-white"
